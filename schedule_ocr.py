...
Смотри на колонку ЛЕНТА (левая, с цифрами). Для каждой СТРОКИ — есть ли там явная цифра?
  ...
  В) Верхняя строка пуста/прочерк, нижняя заполнена → week_mode = "even_only"
  Г) Верхняя заполнена, нижняя пуста/прочерк → week_mode = "odd_only"
...
════════ ПРИМЕР 3: Среда ════════
  ...
  3  | 410  | Системное программирование — Гвоздиевская ОС      ← цифра "3", одна строка

  → лента 2: odd_even (top=Системное, bottom=Технология)
  → лента 3: every_week (Системное) — ОТДЕЛЬНАЯ пара, не путать с лентой 2!
